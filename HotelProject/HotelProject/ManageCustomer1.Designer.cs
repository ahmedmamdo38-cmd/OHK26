namespace HotelProject
{
    partial class ManageCustomer1
    {
        ...
        {
            AlaPanel = new Panel();
            CustomerClearFieldsBT = new Button();
            CustomerRemoveBT = new Button();
            ...
            // 
            CustomerClearFieldsBT.BackColor = Color.SkyBlue;
            CustomerClearFieldsBT.FlatStyle = FlatStyle.Popup;
            CustomerClearFieldsBT.Font = new Font("Tahoma", 12F, FontStyle.Bold, GraphicsUnit.Point);
            CustomerClearFieldsBT.ForeColor = Color.White;
            CustomerClearFieldsBT.Location = new Point(157, 385);
            ...
            // CustomerRemoveBT
            // 
            CustomerRemoveBT.BackColor = Color.SkyBlue;
            CustomerRemoveBT.FlatStyle = FlatStyle.Popup;
            CustomerRemoveBT.Font = new Font("Tahoma", 12F, FontStyle.Bold, GraphicsUnit.Point);
            CustomerRemoveBT.ForeColor = Color.White;
            CustomerRemoveBT.Location = new Point(12, 385);
            CustomerRemoveBT.Name = "CustomerRemoveBT";
            CustomerRemoveBT.Size = new Size(139, 42);
            ...
            // CustomerEditBT
            // 
            CustomerEditBT.BackColor = Color.SkyBlue;
            CustomerEditBT.FlatStyle = FlatStyle.Popup;
            CustomerEditBT.Font = new Font("Tahoma", 12F, FontStyle.Bold, GraphicsUnit.Point);
            CustomerEditBT.ForeColor = Color.White;
            CustomerEditBT.Location = new Point(269, 328);
            ...
            // CustomerAddBT
            // 
            CustomerAddBT.BackColor = Color.SkyBlue;
            CustomerAddBT.FlatStyle = FlatStyle.Popup;
            CustomerAddBT.Font = new Font("Tahoma", 12F, FontStyle.Bold, GraphicsUnit.Point);
            CustomerAddBT.ForeColor = Color.Snow;
            CustomerAddBT.Location = new Point(12, 328);
            ...
            // CustomerPasswordTB
            // 
            CustomerPasswordTB.Font = new Font("Tahoma", 12F, FontStyle.Regular, GraphicsUnit.Point);
            CustomerPasswordTB.Location = new Point(231, 269);
            CustomerPasswordTB.Name = "CustomerPasswordTB";
            ...
            // 
            CustomerPostOfficeTB.Font = new Font("Tahoma", 12F, FontStyle.Regular, GraphicsUnit.Point);
            CustomerPostOfficeTB.Location = new Point(231, 185);
            CustomerPostOfficeTB.Name = "CustomerPostOfficeTB";
            ...
            // CustomerAddressTB
            // 
            CustomerAddressTB.Font = new Font("Tahoma", 12F, FontStyle.Regular, GraphicsUnit.Point);
            CustomerAddressTB.Location = new Point(231, 101);
            CustomerAddressTB.Name = "CustomerAddressTB";
            CustomerAddressTB.Size = new Size(318, 36);
            CustomerAddressTB.TabIndex = 9;
            // 
            // CustomerPasswordLB
            // 
            CustomerPasswordLB.AutoSize = true;
            CustomerPasswordLB.Font = new Font("Tahoma", 12F, FontStyle.Regular, GraphicsUnit.Point);
            CustomerPasswordLB.Location = new Point(12, 276);
            CustomerPasswordLB.Name = "CustomerPasswordLB";
            CustomerPasswordLB.Size = new Size(122, 29);
            ...
            // 
            CustomerPostOfficeLB.AutoSize = true;
            ...
            // CustomerAddressLB
            // 
            CustomerAddressLB.AutoSize = true;
            CustomerAddressLB.Font = new Font("Tahoma", 12F, FontStyle.Regular, GraphicsUnit.Point);
            CustomerAddressLB.Location = new Point(12, 108);
            CustomerAddressLB.Name = "CustomerAddressLB";
            CustomerAddressLB.Size = new Size(105, 29);
            ...
            YlaPanel.Controls.Add(CustomerManagementLB);
        ...
        private Button CustomerClearFieldsBT;
        private Button CustomerRemoveBT;
