...
namespace Task18
{
    public partial class OppilaitosKeyFM : Form
    {
        DataTable oppilaitos = new DataTable();
        DataTable vastuuHenkilot = new DataTable();
        DataTable yhteys = new DataTable();

        public OppilaitosKeyFM()
        {
            InitializeComponent();
        }

        private void OppilaitosKeyFM_Load(object sender, EventArgs e)
        {
        ...
        private void OppilaitoksetCB_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            OKatuosoiteLB.Text = oppilaitos.Rows[OppilaitoksetCB.SelectedIndex]["OKatuosoite"].ToString();
        ...
        {
            VTitteliLB.Text = yhteys.Rows[VastuuHloCB.SelectedIndex]["VTitteli"].ToString();
            VSijaintiLB.Text = yhteys.Rows[VastuuHloCB.SelectedIndex]["VSijainti"].ToString();
            VSahkopostiLB.Text = yhteys.Rows[VastuuHloCB.SelectedIndex]["VSahkoposti"].ToString();
            VPuhelinLB.Text = yhteys.Rows[VastuuHloCB.SelectedIndex]["VPuhelin"].ToString();
        }
